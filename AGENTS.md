...
- Keep facilitator API keys/tokens out of the repo. If needed, pass them only through Netlify environment variables such as `X402_FACILITATOR_AUTH_HEADER_NAME` and `X402_FACILITATOR_AUTH_HEADER_VALUE`.
